...
<head>
    ...
    <title>AllConnect pages prog JAVASCRIPT</title>
    ...
    <div id="header-div1">
        <div class="wrapist">
            <div class="wrapist-title">
                <h1>Bienvenue au cours sur le javascript !</h1>
            </div>
        </div>
    </div>
            ...
            <div class="contain-ul">
                <ul class="list-tags">
                    <li class="active" data-anim="1">
                        <a href="programmation_javascript.php">ACCUEIL</a>
                    </li>
                    <li class="onglets" data-anim="2">
                        <a href="programmation_AllConnect/CSS/contenus_css.php">CONTENU</a>
                    </li>
                    <li class="onglets" data-anim="3">
                        <a href="programmation_AllConnect/CSS/articless_css.php">ARTICLES</a>
                    </li>
                </ul>
            </div>
                ...
                <div class="row">
                                ...
                                <div class="tabs-content">
                                    ...
                                    <div id="accuel_html">
                                        <h2 class="h2_pro">Présentation </h2>
                                            <p>
                                                &nbsp;&nbsp;Javascript est un langage de programmation coté client. Apprendre le langage Javascript vous permettra de réussir des sites Web plus aboutis et plus professionnels. <br> <br>
                                                Il s'agit d'un langage de programmation orienté prototype (et orienté objet à partir de la version 6 d'ECMAscript ou ES6) exécuté sur le navigateur. Il est doté d'un grand potentiel est une syntaxe extrêmement riche qui permet de rendre vos pages Web plus interactives et plus attrayantes. <br> <br>
                                                Né en 1995, il s'agit du premier langage de script développé pour le Web et il est présent sur, quasiment, tous les sites Web professionnels de la toile.
                                            </p>
                                        ...
                                        <h2 class="h2_pro">Comment fonctionne le css ? </h2>
                                            <p>
                                                ...
                                                Il sert également à intégrer des effets esthétiques, toutefois rarement indispensables. Son principal intérêt réside dans son mode de fonctionnement : le langage JavaScript offre en effet la possibilité d'exécuter un code sans être contraint de recharger une page web. En cela, il joue un rôle
                                                dans l'amélioration de la rapidité de chargement des pages, un critère d'ergonomie et de référencement de plus en plus important. <br> <br>
                                                JavaScript peut modifier le contenu HTML. L'une des nombreuses méthodes JavaScript HTML est <b>getElementById().</b>
                                            </p>
                                        <h2 class="h2_pro">Petit conseil de formateur !</h2>
                                            <p>
                                                ...
                                                <br><br>
                                                Néanmoins avant de pouvoir apprendre JavaScript, il est important d'avoir acquis les connaissances en <a href="programmation_html"> HTML</a> et des ALGORITHMES. <br><br>
                                                ...
                                                Quand je dis "apprendre à utiliser le langage" je ne veut dire en aucun cas que vous devez apprendre sa syntaxe par cœur, mais savoir comment éditer un document CSS dans les règles en vous faisant assister par la documentation. <br> <br>
                                                Dans peu de temps, et avec la pratique, vous allez vous rendre compte que vous avez réellement appris la syntaxe. Super! Alors sans plus attendre on passe au <a href="programmation_AllConnect/CSS/contenus_css.php"> contenu </a> de cette formation CSS.
                                            </p>
                                    </div>
                    ...
                    <div id="main-sidebar" class="col-md-3 col-md-offset-1 wow fadeInRight" data-wow-delay="0s">
                        <div class="portfolio-details gap">
                            <div class="carousel-cap"> <h3>Vous êtes en CSS </h3></div>

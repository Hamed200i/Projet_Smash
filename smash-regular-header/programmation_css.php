                                ...
                                <div class="tabs-content">
                                    ...
                                    <div id="accuel_html">
                                        <h2 class="h2_pro">Présentation </h2>
                                            <p>
                                                &nbsp;&nbsp; CSS (Cascading Style Sheets) ou feuilles de style en cascade est un langage de style simple et puissant que l'on va découvrir dans ce cours. Il permet de donner du look à votre page Web et la rendre ainsi présentable.
                                                Si HTML sert à intégrer du contenu, le CSS quant à lui, applique du design à ce contenu. <br> <br>
                                                Il couvre tous les aspects visuels d'une page Web, commençant de la simple coloration des objets et allant jusqu'aux et transformations complexes de ceux ci et le responsive design.    
                                            </p>
                                        ...
                                        <h2 class="h2_pro">Comment fonctionne le css ? </h2>
                                            <p>
                                                ...
                                                Il existe trois(3) façons d'insérer du code CSS; vous pouvez l'insérer directement dans votre même code <a href="programmation_html.php"> html</a> <a href="#"> (CSS interne) </a>, dans un autre fichier avec l'extension <b> .css </b> et le relié <a href="#">  (CSS externe) </a> ou soit en ligne <a href="#"> (CSS en ligne ) </a>  
                                            </p>
                                        ...
                                        <h2 class="h2_pro">Petit conseil de formateur !</h2>
                                            <p>
                                                ...
                                                Dans peu de temps, et avec la pratique, vous allez vous rendre compte que vous avez réellement appris la syntaxe. Super! Alors sans plus attendre on passe au <a href="programmation_AllConnect/CSS/contenu_css.php"> contenu </a> de cette formation CSS.
                                            </p>
                                    </div>

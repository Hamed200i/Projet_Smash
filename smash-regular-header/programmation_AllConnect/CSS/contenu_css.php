...
<body id="page-top" class="index">
    ...
    <div class="main_html">
                ...
                <div class="contenu-lecon">
                    <div>    
                        <span>Leçon 1</span> <br>
                        &nbsp;<a href="#" class="intro">Introduction au CSS </a> 
                    </div>
                    <div>
                        <span>Leçon 2</span> <br>
                        <a href="#">Comment intègre-t-on du code CSS ?</a>
                    </div>  
                    <div>
                        <span>Leçon 3</span> <br>
                        <a href="#">Couleurs de textes et propriétés agissant sur le font</a>
                    </div>
                    <div>
                        <span>Leçon 4</span> <br>
                        <a href="#">Les types de polices</a>
                    </div>
                    <div>
                        <span>Leçon 5</span> <br>
                        <a href="#">Les styles de textes, les marges, les dimentions</a>
                    </div>
                    <div>
                        <span>Leçon 6</span> <br>
                        <a href="#">Les bordures et padding</a>
                    </div>
                    <div>
                        <span>Leçon 7</span> <br>
                        <a href="#">Les positionnements</a>
                    </div>
                    <div>
                        <span>Leçon 8</span> <br>
                        <a href="#">Les selecteurs</a>
                    </div>
                    <div>
                        <span>Leçon 9</span> <br>
                        <a href="#">Les transformations et transition CSS</a>
                    </div>
                    <div>
                        <span>Leçon 10</span> <br>
                        <a href="#">Les médias Queries (Responsive Design)</a>
                    </div>
                    <div>
                        <span>Leçon 11</span> <br>
                        <a href="#">Flexbox (Boîte Flexible)</a>
                    </div>
                    <div>
                        <span>Leçon 12</span> <br>
                        <a href="#">Les animations CSS</a>
                    </div>
                    <div>
                        <span>Leçon 13</span> <br>
                        <a href="#">Opacités CSS</a>
                    </div>
                    <div>
                        <span>Leçon 14</span> <br>
                        <a href="#">Les listes</a>
                    </div>
                    <div>
                        <span>Leçon 15</span> <br>
                        <a href="#">Les Pseudo-Classes Pseudo-Elements</a>
                    </div>
                    <div>
                        <span>Leçon 16</span> <br>
                        <a href="#">Les formulaires</a>
                    </div>
                    <hr>
                    <div class="footer-div">
                        <h3>Séance d'exercice </h3> <br>
                        <a href="#">Styler un formulaire</a> <br>
                        <a href="#">Styler un paragraphe</a> <br>
                        <a href="#">Résumer du cours sur le CSS</a> <br>
                    </div>
                </div>
    </div>
